...
void solve(long long N) {
    if (N % 3 == 0) {
        ...
        vector<string> thalf;
        string t1 = "###";
        REP (i, N-3) t1.push_back('.');
        thalf.push_back(t1);
        c(t1);

        if (N > 7) {
            string t2 = "#..##";
            REP (i, N-5) t2.push_back('.');
            thalf.push_back(t2);
            c(t2);
        } else {
            c("#..#..#");
        ...
        if (N > 7) {
            REP (i, myceil(N, 3LL)/2-2) {
                string ti = "";
                REP (j, 5+3*i) ti.push_back('.');
                REP (j, 3) ti.push_back('#');
                REP (j, N-8-3*i) ti.push_back('.');
                thalf.push_back(ti);
                c(ti);
            }
        }
        ...
        REP (i, N/3-2) {
            string s = "";
            REP (j, 4+i*3) s.push_back('.');
            REP (j, 3) s.push_back('#');
            REP (j, N-(4+i*3)-3) s.push_back('.');
            c(s);
        }

        string t1 = "..##";
        REP (j, N-5) t1.push_back('.');
        t1.push_back('#');
        c(t1);

        string t2 = "##";
        REP (i, N-3) t2.push_back('.');
        t2.push_back('#');
        c(t2);

        string t3 = "#";
        REP (i, N-3) t3.push_back('.');
        t3.push_back('#');
        t3.push_back('#');
        c(t3);
