...
void solve(long long N) {
    ...
    REP (i, s.size()) {
        if (i == s.size()-1) {
            ans += sum((mint)(N+1) - modpow((mint)10, i));
            // cout << ans << endl;
            // ans -= (modpow((mint)10, i) - 1) * ((mint)N - modpow((mint)10, i) - 1);
        } else {
            ans += sum(modpow((mint)10, i+1) - modpow((mint)10, i));
            // cout << ans << endl;
            // ans -= (modpow((mint)10, i) - 1) * (modpow((mint)10, i + 1) - modpow((mint)10, i) - 1);
        }
        // cout << i << " " << ans << endl;
    }
